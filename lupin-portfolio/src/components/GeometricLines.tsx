  ...
  return (
    <>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="550" cy="550" r="500" stroke={S} strokeWidth="0.8" opacity="0.09" />
        <circle cx="550" cy="550" r="380" stroke={S} strokeWidth="0.6" opacity="0.07" />
        <circle cx="550" cy="550" r="260" stroke={S} strokeWidth="0.5" opacity="0.05" />
      </svg>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="300" cy="300" r="280" stroke={S} strokeWidth="0.7" opacity="0.07" />
        <circle cx="300" cy="300" r="180" stroke={S} strokeWidth="0.5" opacity="0.05" />
      </svg>
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 900" preserveAspectRatio="none" fill="none">
        <path d="M 1440 0 Q 800 350 0 900" stroke={S} strokeWidth="0.8" opacity="0.08" />
        <path d="M 1200 0 Q 600 450 -100 700" stroke={S} strokeWidth="0.5" opacity="0.06" />
      </svg>

      {/* Horizontal tangent line */}
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 900" preserveAspectRatio="none" fill="none">
        <line x1="0" y1="450" x2="1440" y2="420" stroke={S} strokeWidth="0.5" opacity="0.05" />
      </svg>
    </>
  );
}
  ...
  return (
    <>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="700" cy="700" r="650" stroke={S} strokeWidth="0.8" opacity="0.08" />
        <circle cx="700" cy="700" r="480" stroke={S} strokeWidth="0.6" opacity="0.06" />
        <circle cx="700" cy="700" r="300" stroke={S} strokeWidth="0.5" opacity="0.045" />
      </svg>
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 2000" preserveAspectRatio="none" fill="none">
        <path d="M -100 100 Q 500 500 1540 300" stroke={S} strokeWidth="0.7" opacity="0.07" />
        <path d="M -100 700 Q 700 950 1540 500" stroke={S} strokeWidth="0.6" opacity="0.06" />
        <path d="M 1540 100 Q 900 600 -100 800" stroke={S} strokeWidth="0.5" opacity="0.05" />
      </svg>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="350" cy="350" r="330" stroke={S} strokeWidth="0.7" opacity="0.06" />
      </svg>
    </>
  );
}
  ...
  return (
    <>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="450" cy="450" r="420" stroke={S} strokeWidth="0.8" opacity="0.08" />
        <circle cx="450" cy="450" r="310" stroke={S} strokeWidth="0.6" opacity="0.06" />
      </svg>
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 600" preserveAspectRatio="none" fill="none">
        <path d="M 0 80 Q 360 280 720 180 Q 1080 80 1440 280" stroke={S} strokeWidth="0.8" opacity="0.07" />
        <path d="M 0 400 Q 480 200 960 350 Q 1200 450 1440 300" stroke={S} strokeWidth="0.5" opacity="0.055" />
      </svg>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="275" cy="275" r="260" stroke={S} strokeWidth="0.6" opacity="0.06" />
      </svg>

      {/* Diagonal accent */}
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 600" preserveAspectRatio="none" fill="none">
        <line x1="200" y1="600" x2="1300" y2="0" stroke={S} strokeWidth="0.5" opacity="0.04" />
      </svg>
    </>
  );
}
  ...
  return (
    <>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="400" cy="400" r="370" stroke={S} strokeWidth="0.8" opacity="0.08" />
        <circle cx="400" cy="400" r="260" stroke={S} strokeWidth="0.6" opacity="0.06" />
      </svg>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="250" cy="250" r="230" stroke={S} strokeWidth="0.6" opacity="0.06" />
      </svg>

      {/* Flowing curve */}
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 500" preserveAspectRatio="none" fill="none">
        <path d="M 0 420 Q 500 150 1000 300 Q 1300 400 1440 200" stroke={S} strokeWidth="0.7" opacity="0.07" />
        <path d="M 0 250 Q 720 450 1440 180" stroke={S} strokeWidth="0.5" opacity="0.05" />
      </svg>
    </>
  );
}
  ...
  return (
    <>
      ...
      <svg
        ...
        fill="none"
      >
        <ellipse cx="550" cy="700" rx="520" ry="520" stroke={S} strokeWidth="0.8" opacity="0.08" />
        <ellipse cx="550" cy="700" rx="380" ry="380" stroke={S} strokeWidth="0.6" opacity="0.06" />
      </svg>
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 800" preserveAspectRatio="none" fill="none">
        <path d="M 100 800 Q 720 350 1350 0" stroke={S} strokeWidth="0.7" opacity="0.07" />
        <path d="M 400 800 Q 900 500 1440 100" stroke={S} strokeWidth="0.5" opacity="0.055" />
      </svg>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="225" cy="225" r="210" stroke={S} strokeWidth="0.6" opacity="0.06" />
      </svg>

      {/* Horizontal tangent */}
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 800" preserveAspectRatio="none" fill="none">
        <line x1="0" y1="200" x2="1440" y2="180" stroke={S} strokeWidth="0.4" opacity="0.05" />
      </svg>
    </>
  );
}
...
function HeroLines() {
  return (
    <svg
      ...
      fill="none"
    >
      <circle cx="720" cy="550" r="500" stroke="#ffffff" strokeWidth="0.8" opacity="0.06" />
      <circle cx="720" cy="550" r="380" stroke="#ffffff" strokeWidth="0.6" opacity="0.045" />
      <circle cx="720" cy="550" r="250" stroke="#ffffff" strokeWidth="0.5" opacity="0.035" />
      {/* Diagonal accent lines */}
      <path d="M 0 900 Q 720 400 1440 0" stroke="#ffffff" strokeWidth="0.5" opacity="0.03" />
      <path d="M 0 0 Q 720 500 1440 900" stroke="#ffffff" strokeWidth="0.4" opacity="0.025" />
    </svg>
  );
}
