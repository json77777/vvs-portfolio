  ...
  return (
    ...
    >
      ...
      <div className="container-wide relative z-10">
        ...
        <div className="cta-link mt-14" style={{ opacity: 0 }}>
          <a
            href="mailto:hello@lupin.studio"
            className="arrow-link group inline-flex items-center font-label text-base tracking-wide text-ink-muted hover:text-ink transition-colors duration-300"
          >
